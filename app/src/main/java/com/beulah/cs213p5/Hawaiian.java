...
public class Hawaiian extends Pizza{
    ...
    public Hawaiian(Size size, boolean extraSauce, boolean extraCheese) {
        super(getHawaiianToppings(), size, Sauce.TOMATO, extraSauce, extraCheese);
    }
     ...
     */
    private static ArrayList<Topping> getHawaiianToppings() {
...
//        }
    ...
    public String toString() {
        ...
        String fString = "[Hawaiian] ";
        for (Topping topping : getHawaiianToppings()) { // [type] topping1, topping2, etc. //changed this from toppings to getDeluxe toppings
