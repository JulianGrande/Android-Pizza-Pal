...
public class BuffaloChicken extends Pizza{
    ...
    public BuffaloChicken(Size size, boolean extraSauce, boolean extraCheese) {
        super(getBCToppings(), size, Sauce.TOMATO, extraSauce, extraCheese);
    }
     ...
     */
    private static ArrayList<Topping> getBCToppings() {
...
//        }
    ...
    public String toString() {
        ...
        String fString = "[Buffalo Chicken] ";
        for (Topping topping : getBCToppings()) { // [type] topping1, topping2, etc. //changed this from toppings to getDeluxe toppings
