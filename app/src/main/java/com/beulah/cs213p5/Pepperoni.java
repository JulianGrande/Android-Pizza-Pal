...
/**
 * Pepperoni pizza class with preset toppings and sauce
 * @author Julian Grande, Vansh Sharma
 */
public class Pepperoni extends Pizza{

    public static final double SMALL_PRICE = 10.99; //all prices are based around price of small pizza
    ...
    public Pepperoni(Size size, boolean extraSauce, boolean extraCheese) {
        super(getMeatzzaToppings(), size, Sauce.TOMATO, extraSauce, extraCheese);
    }

    /**
     * Populates an array list with the toppings for a pepperoni pizza
     * @return array list of toppings
     */
    private static ArrayList<Topping> getMeatzzaToppings() {
...
//        }
    ...
    public String toString() {
        ...
        String fString = "[Pepperoni] ";
        for (Topping topping : getMeatzzaToppings()) { // [type] topping1, topping2, etc.
