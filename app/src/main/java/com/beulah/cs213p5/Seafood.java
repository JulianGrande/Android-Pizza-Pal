...
/**
 * Seafood pizza class with preset toppings and sauce
 * @author Julian Grande, Vansh Sharma
 */
public class Seafood extends Pizza{

    public static final double SMALL_PRICE = 17.99; //all prices are based around price of small pizza
    ...
    public Seafood(Size size, boolean extraSauce, boolean extraCheese) {
        super(getSeafoodToppings(), size, Sauce.ALFREDO, extraSauce, extraCheese);
    }

    /**
     * Populates an array list with the toppings for a seafood pizza
     * @return array list of toppings
     */
    private static ArrayList<Topping> getSeafoodToppings() {
...
//        }
    ...
    public String toString() {
        ...
        String fString = "[Seafood] ";
        for (Topping topping : getSeafoodToppings()) { // [type] topping1, topping2, etc.
