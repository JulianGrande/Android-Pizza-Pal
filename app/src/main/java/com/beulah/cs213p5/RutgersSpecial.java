...
public class RutgersSpecial extends Pizza{
     ...
     */
    public RutgersSpecial(Size size, boolean extraSauce, boolean extraCheese) {
        super(getRUSToppings(), size, Sauce.TOMATO, extraSauce, extraCheese);
    }
     ...
     */
    private static ArrayList<Topping> getRUSToppings() {
...
//        }
    ...
    public String toString() {
        ...
        String fString = "[RUS] ";
        for (Topping topping : getRUSToppings()) { // [type] topping1, topping2, etc. //changed this from toppings to getDeluxe toppings
