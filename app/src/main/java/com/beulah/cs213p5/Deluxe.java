...
/**
 * Deluxe pizza class with preset toppings and sauce
...
public class Deluxe extends Pizza{
    ...
    public Deluxe(Size size, boolean extraSauce, boolean extraCheese) {
        super(getDeluxeToppings(), size, Sauce.TOMATO, extraSauce, extraCheese);
    }
     ...
     */
    private static ArrayList<Topping> getDeluxeToppings() {
    ...
    public String toString() {
        ...
        String fString = "[Deluxe] ";
        for (Topping topping : getDeluxeToppings()) { // [type] topping1, topping2, etc. //changed this from toppings to getDeluxe toppings
