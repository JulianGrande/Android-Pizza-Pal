...
/**
 * Supreme pizza class with preset toppings and sauce
 * @author Julian Grande, Vansh Sharma
 */
public class Supreme extends Pizza{

    public static final double SMALL_PRICE = 15.99; //all prices are based around price of small pizza
    ...
    public Supreme(Size size, boolean extraSauce, boolean extraCheese) {
        super(getSupremeToppings(), size, Sauce.TOMATO, extraSauce, extraCheese);
    }

    /**
     * Populates an array list with the toppings for a supreme pizza
     * @return array list of toppings
     */
    private static ArrayList<Topping> getSupremeToppings() {
...
//        }
    ...
    public String toString() {
        ...
        String fString = "[Supreme] ";
        for (Topping topping : getSupremeToppings()) { // [type] topping1, topping2, etc.
