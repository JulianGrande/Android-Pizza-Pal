...
public class Margharita extends Pizza{
     ...
     */
    public Margharita(Size size, boolean extraSauce, boolean extraCheese) {
        super(getMargToppings(), size, Sauce.TOMATO, extraSauce, extraCheese);
    }
     ...
     */
    private static ArrayList<Topping> getMargToppings() {
        ArrayList<Topping> toppings = new ArrayList<>();
        toppings.add(Topping.BASIL);
        toppings.add(Topping.PARMESAN_CHEESE);
        return toppings;
    }
...
//        }
    ...
    public String toString() {
        ...
        String fString = "[Margharita] ";
        for (Topping topping : getMargToppings()) { // [type] topping1, topping2, etc. //changed this from toppings to getDeluxe toppings
